...
If You have NPM 5 You have to install yarn to use react Native or downgrade NPM to 4 version.

To start use:
1. `git clone` to clone this repo,
2. `yarn install` to instal dependencies,
3. `yarn start`  to starting compilation,
4. install Expo in Your Phone for live preview ;)

## React Native Create App Docs
